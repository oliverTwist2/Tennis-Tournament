...
const challengedSchema = new mongoose.Schema(
  {
    _club: { type: String, required: true, default: () => uuidv4() },
    state: { type: String, required: true, default: "pending", enum: ["accepted", "pending", "rejected"] },
...
const Challenged = mongoose.model("Challenged", challengedSchema);

module.exports = Challenged;
